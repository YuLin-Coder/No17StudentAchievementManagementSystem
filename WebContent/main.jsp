	...
	<body>
		<div class="dvheader">
			<div class="dvheadertools">
				<span class="headerspantitle">学生成绩管理系统</span>
		...
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					<i class="icon-cog menuicon"></i>管理菜单<b class="arrow icon-angle-down arrow-down"></b>
					<ul class="ulleftsubitems">
						<a href=studentInfo.action target="right">
							<li>学生信息管理</li>
						</a>
						<a href="courseInfo.action" target="right">
							<li>课程信息管理</li>
						</a>
						<a href="scoreInfo.action" target="right">
							<li>成绩信息管理</li>
						</a>
<!--						<a href="warning.html" target="right">
			...
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="other.jsp" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
